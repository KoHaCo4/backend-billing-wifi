...
// Test cron
router.get("/cron-test", testController.testCronStatus);

// Test fonnte connection
router.get("/fonnte-test", testController.testFonnteConnection);

// Test database connection
router.get("/db-test", testController.testDatabaseConnection);

// System health check
router.get("/health", testController.testSystemHealth);
